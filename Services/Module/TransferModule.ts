...
import type { TransferModuleExportsOrImport, ProviderLocation } from "./interfaces";
import { moduleHasImport } from "./utils";
...
class NactTransferModule {
	...
	_initPhase(): void {
		...
		this._beginResolvingPhase();
		this._closingResolvingPhase();
	}
